...
export default function NodesPage() {
    ...
    async function saveNode() {
        ...
        try {
            ...
            await apiFetch<Node>(`/nodes/${selected.id}`, { method: "PUT", body: payload });
            await refresh();
        } catch (e) {
            setErr(e instanceof Error ? e.message : String(e));
        } finally {
    ...
    async function deleteNode() {
        ...
        setLoading(true);
        try {
            await apiFetch<{ status: string }>(`/nodes/${selected.id}`, { method: "DELETE" });
            setSelectedId(null);
            await refresh();
        } catch (e) {
            setErr(e instanceof Error ? e.message : String(e));
    ...
    async function pushConfig() {
        ...
        setLoading(true);
        try {
            const resp = await apiFetch<PushResp>(`/nodes/${selected.id}/push`, { method: "POST" });
